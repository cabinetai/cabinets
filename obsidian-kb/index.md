...
Import your Obsidian vault from Integrations in Cabinet, or when Cabinet asks. It's
a one-off import, not a live connection: Cabinet reads your vault once and mirrors
it in as plain markdown. Run the import again whenever you want a fresher build.
