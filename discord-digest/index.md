...
Connect Discord from Integrations in Cabinet, or when Cabinet asks. You do it once; after
that it stays connected and you never touch it again. Until then the page keeps showing the
example.
