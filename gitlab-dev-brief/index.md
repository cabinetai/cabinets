...
flipped: GitLab is not offered under Integrations in Cabinet yet, so there is nothing for
you to connect to. This cabinet is written as though there were, and waits.
...
- The example brief stays on screen until GitLab is offered.

When it is, you connect GitLab from Integrations in Cabinet, or when Cabinet asks (your
company's server, or gitlab.com), and this page starts filling in by itself.
