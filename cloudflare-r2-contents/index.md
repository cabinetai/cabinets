...
Connect R2 from Integrations in Cabinet, or when Cabinet asks. Cabinet syncs the
bucket down as ordinary files. Nothing here talks to Cloudflare: it reads the
