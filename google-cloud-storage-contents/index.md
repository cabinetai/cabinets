...
Connect Google Cloud Storage from Integrations in Cabinet, or when Cabinet asks.
Cabinet syncs the bucket down as ordinary files. Nothing here talks to Google: it
