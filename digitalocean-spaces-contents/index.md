...
Connect Spaces from Integrations in Cabinet, or when Cabinet asks. Cabinet syncs
the Space down as ordinary files. Nothing here talks to DigitalOcean: it reads
the files after they land.
