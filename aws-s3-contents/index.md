...
Connect S3 from Integrations in Cabinet, or when Cabinet asks. Cabinet syncs the
bucket down as ordinary files. Nothing here talks to Amazon: it reads the files
after they land.
