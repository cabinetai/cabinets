---
title: Safari Site Check
created: '2026-08-13T00:00:00Z'
modified: '2026-09-15T00:00:00Z'
tags: [safari, browser, monitoring, showcase]
order: 1
---
# Safari Site Check

Every morning, opens your site in Safari and tells you if anything broke.
...
## Before it can check your site

Safari is macOS only, so this cabinet only does anything on a Mac: there's no
Safari to drive on Windows or Linux. Connect Safari from Integrations in Cabinet, or
when Cabinet asks. There is no account to make: Cabinet drives Safari on this
computer, and your agents can open a real browser from then on. Until you connect,
